...
export default defineComponent({
  ...
  setup() {
    ...
    const playStation = (payload: any /* RadioStationResponse */) => {
    ...
    const saveStationToDatabase = async (station: any /* RadioStationResponse */) => {
    ...
    const removeStationFromDatabase = async (payload: any /* RadioStationResponse */) => {
